...
// other call sites (watchdog's countFiles, clip classifiers)
// import them by destructuring here.
const {
  createQueueWatcher,
  isAudioFile,
  AUDIO_OR_PARTIAL_RE,
...
// Session launcher (launchAssistantSession + launchAssistantSessionMac +
// launchClaudeDesktopCodeSession) extracted to app/lib/codex-launch.js
// 2026-05-08 (Phase 0 of v0.7 housekeeping) to keep main.js under the
// 2725-line absolute file-length ceiling. The factory below preserves
// the original interface — the IPC handler and rest of main.js call
// `launchAssistantSession(payload)` exactly as before.
const { createSessionLauncher } = require('./lib/codex-launch');
const _sessionLauncher = createSessionLauncher({
  spawn,
  crypto,
  path,
  fs,

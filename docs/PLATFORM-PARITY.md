...
| Native dictation trigger | Terminal Talk hotkey pauses TTS then toggles Windows voice typing via Win+H | Terminal Talk hotkey pauses TTS then toggles Apple Dictation via foreground Edit menu, with Fn/Fn fallback | Equivalent intent, OS UI differs |
